...
summary: A federated learning model over the blockchain is presented and tested by developing a machine learning algorithm for mode inference.
...
links:
 - name: "Web"
   url: "http://www.icmconference.org.uk/index.php/icmc/ICMC2019/paper/view/1479"
url_pdf: ''
url_code: ''
url_dataset: ''
url_poster: ''
...
image:
  caption: 'Image credit: [**ICMC**](http://www.icmconference.org.uk/index.php/icmc/ICMC2019)'
  focal_point: ""
  preview_only: true
